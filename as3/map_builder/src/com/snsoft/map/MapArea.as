package com.snsoft.map {
	...
	public class MapArea extends MapComponent {
		...
		private var IS_CURRENT_COLOR:uint = 0xff0000;
		...
		override protected function draw():void {
			...
			var fcolor:uint = this.fillColor;
			if (mado.isCurrent) {
				fcolor = IS_CURRENT_COLOR;
			}
			areaFillShape = MapDraw.drawFill(paa, this.lineColor, fcolor, 0, this.scalePoint);
