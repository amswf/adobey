package com.snsoft.tvc2.map {
	...
	public class PriceMapArea extends Business {
		...
		override protected function play():void {
			...
			cutLine.y = rect.y + rect.height + XMLFastConfig.getCfgInt("areaCutLineY");
		...
		private function playAreaView():void {
			...
			if (soundsCmp && areasCmp) {
				...
				if (listDOV != null && listCount >= 0 && listCount < listDOV.length) {
					...
					currentText.x = rect.width / 2 + switchMoveLenth + XMLFastConfig.getCfgInt("areaTitleX");
					currentText.y = XMLFastConfig.getCfgInt("areaTitleY");
