...
package fl.video {
     ...
     * <p>For Flash Player Update 3 (version 9.0.115.0) and later, the FLVPlayback component was updated
     * to support high-definition MPEG-4 video formats that utilize industry standard H.264 encoding. For more
     * information on the video formats supported by the FLVPlayback component, 
     * see <a href="http://www.adobe.com/devnet/flash/articles/flvplayback_programming.html" target="mm_external">
     * Controlling web video with ActionScript 3 FLVPlayback programming</a>.</p>
     *
	...
	public class FLVPlayback extends Sprite {
		...
		public function FLVPlayback() {
			...
			// create UIManager
			if (uiMgr == null) uiMgr = new UIManager(this);
			if (isLivePreview) {
				uiMgr.visible = true;
			}
	...
	*/
		...
		flvplayback_internal function queueCmd(vpState:VideoPlayerState, type:Number, time:Number=NaN):void {
			...
			vpState.cmdQueue.push(new QueuedCommand(type, null, false, time, NaN, NaN));
		}
