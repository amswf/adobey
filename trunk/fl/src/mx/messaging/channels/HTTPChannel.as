...
public class HTTPChannel extends PollingChannel
{
    ...
    private function decodePacket(event:Event):AsyncMessage
    {
        ...
        return packet.result as AsyncMessage;
    }
    ...
    {
        var msg:AsyncMessage = decodePacket(event);
...
class HTTPMessageResponder extends MessageResponder
{
    ...
    {
        if (value != null)
            (channel as HTTPChannel).appendToURL = value;
    }
