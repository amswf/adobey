package com.snsoft.tvc2 {
	...
	public class Business extends UIComponent {
		...
		protected var isRemoved:Boolean = false;
		...
		public function stopTimer():void {
			if (delayFrameTimer != null) {
				delayFrameTimer.stop();
			}
			if (timeLengthFrameTimer != null) {
				timeLengthFrameTimer.stop();
			}
			if (timeOutFrameTimer != null) {
				timeOutFrameTimer.stop();
			}
		}
