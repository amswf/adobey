package tvc {
	...
	public class ParseXMLFile {
		...
		public static var infos:Array = new Array();
		public static var sign:Boolean = false;
			...
			for (var iXml:int = 0; iXml < xmlList.length(); iXml++) {
				...
				if (true) {
					...
					for (var ial:int = 0; ial < areasList.length(); ial++) {
						...
						for (var ipl:int = 0; ipl < pricesList.length(); ipl++) {
				...
				if (true) {
					...
					for (var ipal:int = 0; ipal < pareasList.length(); ipal++) {
						...
						for (var ippl:int = 0; ippl < ppricesList.length(); ippl++) {
