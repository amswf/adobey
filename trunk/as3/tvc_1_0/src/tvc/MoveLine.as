package tvc {
   ...
   * shap.addEventListener(Event.ENTER_FRAME,ml.lineEnterFrameHandler);
	...
	public class MoveLine {
		...
		private var sign:Number = 0;
		private var f_x:Number = 0;
		private var f_y:Number = 0;
		private var t_x:Number = 0;
		private var t_y:Number = 0;
		private var line:Shape = null;
		private var point:Shape = null;
		private var movie:MovieClip = new MovieClip();
		private var borderColor:int = 0x000000;
		private var borderSize:Number = 1;
		private var alpha:Number = 100;
		private var c:Number = 0;
		private var speed:Number = 1;
		private var array:Array = new Array(); //结点数组(坐标值)
		private var valuePointArray:Array = new Array(); //结点数组(原始值)
		private var valuePoint_Y:Number = 0;
		private var listOfnextIndex:int = 0;
		private var points:MovieClip = new MovieClip();
		private var pointWidth:Number = 0; //画结点长方形时,长方形的宽度
		private var pointHeight:Number = 0; //画结点长方形时,长方形的高度
		...
		连续画线到指定位置:
		*/
		public function setLineTo(tx:Number, ty:Number):void {
			this.f_x=this.t_x;
			this.f_y=this.t_y;
			this.t_x=tx;
			this.t_y=ty;
