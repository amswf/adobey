package com.snsoft.map {
	...
	public class Pen extends MapComponent {
		...
		//画笔遇到已存在点时，皮夫MC的类名。
		public static const PEN_PATH_POINT_SKIN:String = "PenPathPointSkin";

		//画笔默认，皮夫MC的类名。
		public static const PEN_PATH_DEFAULT_SKIN:String = "PenPathDefaultSkin";
		...
		public static const PEN_SELECT_DELETE_SKIN:String = "PenSelectDeleteSkin";
