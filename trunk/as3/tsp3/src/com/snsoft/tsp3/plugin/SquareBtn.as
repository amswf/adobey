package com.snsoft.tsp3.plugin {
	 ...
	 *
	 */
	public class SquareBtn extends Sprite {
		...
		public function SquareBtn(imgSize:Point, img:BitmapData, text:String, uuid:String = null, tft:TextFormat = null, embedFonts:Boolean = false) {
			super();
