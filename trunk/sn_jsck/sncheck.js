var SnJsckForm = function(formId){
    ...
    function checkElement(ele){
        ...
        var minlenStr = getElementAttribute(nele, ELE_ATTR_MIN_LENGTH, MIN_LENGTH_DEFAULT_VALUE);
        var maxlenStr = getElementAttribute(nele, ELE_ATTR_MAX_LENGTH, MAX_LENGTH_DEFAULT_VALUE);
        var ctypeStr = getElementAttribute(nele, ELE_ATTR_CHECK_TYPE, CHECK_TYPE_DEFAULT);
        var cfmtStr = getElementAttribute(nele, ELE_ATTR_CHECK_FORMAT, CHECK_FORMAT_DEFAULT_VALUE);
        var cmsgStr = getElementAttribute(nele, ELE_ATTR_CHECK_MSG, CHECK_MSG_DEFAULT_VALUE);
    ...
    function initBaseDiv(){
        ...
        for (var i = 0; i < formsAry.length; i++) {
			...
			var sign = false;
			if(jsckDiv != null){
				if(jsckDiv.document.getElementById(formDivId) != null){
					sign = true;
				}
			}
