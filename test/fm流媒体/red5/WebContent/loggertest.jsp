<%@page
	import="org.slf4j.Logger,org.slf4j.LoggerFactory,org.slf4j.impl.StaticLoggerBinder,ch.qos.logback.classic.LoggerContext,org.red5.logging.LoggingContextSelector,org.red5.logging.Red5LoggerFactory"%>
<html>
<body>
<%
	Logger log = Red5LoggerFactory.getLogger(this.getClass());
